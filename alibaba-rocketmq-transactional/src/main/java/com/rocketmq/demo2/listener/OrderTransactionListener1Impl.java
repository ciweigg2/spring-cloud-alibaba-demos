package com.rocketmq.demo2.listener;
 ...
 * @desc 测试自定义消费
 */
@RocketMQTransactionListener(txProducerGroup = "order-tx-produce-group1", corePoolSize = 5, maximumPoolSize = 10)
public class OrderTransactionListener1Impl implements RocketMQLocalTransactionListener {
    ...
    public RocketMQLocalTransactionState checkLocalTransaction(Message message) {
        ...
        //判断之前的事务是否已经提交：订单记录是否已经保存 需要控制重复消息
        int count = 1;
